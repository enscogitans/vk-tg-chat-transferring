...
class ConverterService:
    def __init__(self, vk_config: Config.Vk,
                 ...
                 vk_history_repository: VkHistoryRepository,
                 tg_history_repository: TgHistoryRepository) -> None:
        ...
        self.vk_history_repository = vk_history_repository
        self.tg_history_repository = tg_history_repository
    ...
    def export_dummy_history(self, contacts_file: Path, export_file: Path) -> None:
        ...
        self.tg_history_repository.save_history(tg_history, export_file)
    ...
    async def export_converted_history(self, vk_history_file: Path, contacts_file_opt: Optional[Path],
        ...
        vk_history = self.vk_history_repository.load_history(vk_history_file)
