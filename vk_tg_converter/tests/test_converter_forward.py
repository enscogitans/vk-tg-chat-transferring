...
async def test_simple_forward(converter):
    ...
    vk_msg_2 = vk.Message(date=make_ts(0, 1), from_id=101, text="", fwd_messages=(vk_msg_1,))
...
async def test_forward_with_mention(converter):
    vk_msg_1 = vk.Message(date=make_ts(0, 0), from_id=100, text="Hi, [id151515151|Alice], [id151515152|Bob]!")
...
async def test_forward_two_messages(converter):
    vk_msg_1 = vk.Message(date=make_ts(0, 0), from_id=100, text="Hi!")
    vk_msg_2 = vk.Message(date=make_ts(0, 1), from_id=101, text="Bonjour")
    vk_msg_3 = vk.Message(date=make_ts(0, 2), from_id=102, text="Hello", fwd_messages=(vk_msg_1, vk_msg_2,))
...
async def test_forward_message_with_reply(converter):
    ...
    vk_msg_3 = vk.Message(date=make_ts(0, 2), from_id=102, text="Bonjour", fwd_messages=(vk_msg_2,))
...
async def test_nested_forward(converter):
    ...
    vk_msg_2 = vk.Message(date=make_ts(0, 1), from_id=101, text="Hello", fwd_messages=(vk_msg_1,))
    vk_msg_3 = vk.Message(date=make_ts(0, 2), from_id=102, text="Bonjour", fwd_messages=(vk_msg_2,))
    vk_msg_4 = vk.Message(date=make_ts(0, 3), from_id=103, text="Salut", fwd_messages=(vk_msg_1,))
    vk_msg_5 = vk.Message(date=make_ts(0, 4), from_id=100, text="Is this English?",
